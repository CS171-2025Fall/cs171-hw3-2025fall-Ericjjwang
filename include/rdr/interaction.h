...
public:
  ...
  void setDifferential(const Vec3f &in_p, const Vec3f &in_normal,
    ...
    AssertAllNormalized(in_normal);
    // [Pending] TODO: Should determine the direction
  ...
  void setShading(const Vec3f &in_normal, const Vec3f &in_dpdu,
    ...
    // [Pending] TODO: why in_normal shoule be set as in_dpdu x in_dpdv
    // AssertNear(in_normal, Normalize(Cross(in_dpdu, in_dpdv)));
